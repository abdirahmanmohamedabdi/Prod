...
export default function Example() {
  ...
  const handleNavigationClick = (pageName) => {
    setActivePage(pageName); // Update the active page when an item is clicked
  };
                    ...
                    {navigationItems.map((item) => (
                      <a
                        ...
                        className={classNames(
                          ...
                          'group rounded-md py-2 px-2 flex items-center text-base font-medium cursor-pointer'
                        )}
                      >
                        <item.icon
                          className={classNames(
                            activePage === item.name ? 'text-gray-500' : 'text-gray-400 group-hover:text-gray-500',
